...
INSERT INTO pttype (pttype, name) VALUES
  ('02', 'ประกันสังคม กรณีเจ็บป่วย'),
  ('03', 'ประกันสังคม ทุพพลภาพ'),
  ('04', 'ประกันสังคม กรณีคลอด'),
  ('05', 'ประกันสังคม ทันตกรรม'),
  ('74', 'UC สิทธิ์บัตรทอง 30 บาท'),
  ('A0', 'ข้าราชการ/รัฐวิสาหกิจ'),
  ('S1', 'ผู้ประกันตน ม.33 (ประกันสังคม)')
ON CONFLICT DO NOTHING;
...
INSERT INTO ovst (vn, hn, vstdate, vsttime, doctor, cur_dep, ovstist, ovstost, pttype)
VALUES
  ('6801001000001', '000857160', '2025-11-15', '09:00:00', '0001', '003', '1', '1', '02'),
  ('6801001000002', '000857160', '2025-12-10', '09:30:00', '0001', '003', '1', '1', '02'),
  ('6801001000003', '000857160', '2026-01-08', '10:00:00', '0002', '003', '1', '1', '02')
ON CONFLICT DO NOTHING;
...
INSERT INTO ovst (vn, hn, vstdate, vsttime, doctor, cur_dep, ovstist, ovstost, pttype)
VALUES
  ('6802001000001', '000123456', '2025-10-01', '08:30:00', '0002', '003', '1', '1', 'S1'),
  ('6802001000002', '000123456', '2025-10-02', '13:00:00', '0003', '003', '1', '1', 'S1')
ON CONFLICT DO NOTHING;
...
VALUES
  ('680100001', '000234567', '6803001000001', '2025-12-01', '10:00:00', '2025-12-08', '11:00:00', '01', '02', '0201', '02', '02', '0002', '17001', 2.5, 2.3),
  ('680100002', '000234567', '6803001000002', '2026-01-15', '09:00:00', '2026-01-17', '14:00:00', '01', '01', '0101', '01', '02', '0001', '40580', 1.2, 1.1)
ON CONFLICT DO NOTHING;

-- OPD records linking to the admissions
INSERT INTO ovst (vn, hn, vstdate, vsttime, doctor, cur_dep, ovstist, ovstost, an, pttype)
VALUES
  ('6803001000001', '000234567', '2025-12-01', '10:00:00', '0002', '002', '1', '1', '680100001', '02'),
  ('6803001000002', '000234567', '2026-01-15', '09:00:00', '0001', '001', '1', '1', '680100002', '02')
ON CONFLICT DO NOTHING;
