...
import { ArrowLeft, FlaskConical, Plus, X, Search } from 'lucide-react';
...
export default function RegimenCreatePage() {
  ...
  // Check if drug is already linked
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-glass-border-subtle bg-white/10 dark:bg-white/5">
                      ...
                      <th className="px-4 py-2.5 text-center font-medium text-muted-foreground w-16">ลบ</th>
                    </tr>
                  </thead>
                  <tbody>
                    {linkedDrugs.map((ld) => (
                      <tr key={ld.drugId} className="border-b last:border-0">
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium">{ld.genericName}</span>
                          </div>
                        </td>
                        <td className="px-4 py-3 tabular-nums">{ld.dosePerCycle || '—'}</td>
                        <td className="px-4 py-3">
